...
<?php 
//do action to used codes table before
do_action('woo_vou_used_codes_table_before'); 
?>
			...
			<tr class="woo-vou-used-codes-row-body">
				...
				<td class="code_details column-code_details" data-colname="View Details">
					...
					<?php
						...
						//do action to add in view details column
						do_action( 'woo_vou_used_codes_after_view_details_column', $value );
					?>
				</td>
				<?php } // if order found
