...
class WOO_Vou_Admin_Meta { 
	...
	public function woo_vou_product_write_panel( $wcmp = false ) {
		...
		$woo_vou_tab_options = array(
			...
			//'voupayyourprice'	=> esc_html__( 'Pay Your Price', 'woovoucher' ),
		);

		if(!$is_variable){
			$woo_vou_tab_options['voupayyourprice'] = esc_html__( 'Pay Your Price', 'woovoucher' );
		}
		...
		echo '<div id="woo_vou_voucher" class="panel wc-metaboxes-wrapper woocommerce_options_panel tabs-content hide-all">';
			...
			if(!$is_variable){
				// Pay your price tab start			
				$this->woo_vou_add_checkbox( 
					array( 
						'id' => $prefix . 'enabel_pay_your_price', 
						'field_type' => 'voupayyourprice', 
						'label' => esc_html__('Enable Pay Your Price:', 'woovoucher' ), 
						'description' => esc_html__( 'Enable Pay Your Price if you want users to pay their own price for this product.', 'woovoucher' ) 					
					) 
				);
				echo '<div class="enabel_pay_your_price_detail_wrap">';
					$this->woo_vou_add_select( 
						array( 
							'id' 				=> $prefix . 'woo_vou_pay_your_price_input_field_type', 
							'field_type' 		=> 'voupayyourprice', 
							'label' 			=> esc_html__('Input Field Type', 'woovoucher' ), 
							'description' 		=> esc_html__( "Select the input field type: 'Text' or 'Button & Text'.", 'woovoucher' ),
							'wrap_class' 		=> 'woo_vou_pay_your_price_details',
							'style' 			=> 'width:45%; min-width:200px;', 
							'class' 			=> 'wc-enhanced-select woo_vou_pay_your_price',
							'options'			=> array(
								'text'				=> esc_html__( 'Text', 'woovoucher' ),
								'button_and_text'	=> esc_html__( 'Button & Text', 'woovoucher' ),
							),
						) 
					);
					$this->woo_vou_add_text( 
						array( 
							'id' 			=> $prefix . 'woo_vou_pay_your_price_input_field_type_amount_values', 
							//'class' 		=> 'woo_vou_pay_your_price',
							'field_type' 	=> 'voupayyourprice',  
							'wrap_class' 	=> 'woo_vou_pay_your_price_details', 
							'label' 		=> sprintf( __('Amount (%1$s):', 'woovoucher'), get_woocommerce_currency_symbol() ), 
							'description' 	=> esc_html__( 'Enter comma-separated values for the Button & Text input field type.' , 'woovoucher' ), 
						)
					);

					$this->woo_vou_add_number( 
						array( 
							'id' 			=> $prefix . 'woo_vou_pay_your_recommended_price', 
							'class' 		=> 'woo_vou_pay_your_price',
							'field_type' 	=> 'voupayyourprice',  
							'wrap_class' 	=> 'woo_vou_pay_your_price_details', 
							'label' 		=> sprintf( __('Recommended Price  (%1$s):', 'woovoucher'), get_woocommerce_currency_symbol() ), 
							'description' 	=> esc_html__( 'The recommended price prompts users to enter that amount.' , 'woovoucher' ), 
						)
					);
					$this->woo_vou_add_number( 
						array( 
							'id' 			=> $prefix . 'woo_vou_pay_your_min_price', 
							'class' 		=> 'woo_vou_pay_your_price', 
							'wrap_class' 	=> 'woo_vou_pay_your_price_details', 
							'label' 		=> sprintf( __('Minimum Price  (%1$s):', 'woovoucher'), get_woocommerce_currency_symbol() ), 
							'description'	=> esc_html__( 'The minimum price prevents products from being sold for less than you are willing to accept.', 'woovoucher' ),
							'field_type' 	=> 'voupayyourprice', 
						)
					);
					$this->woo_vou_add_checkbox( 
						array( 
							'id' 			=> $prefix . 'woo_vou_hide_pay_your_min_price', 
							'field_type'	=> 'voupayyourprice', 
							'label' 		=> esc_html__('Hide Minimum Price Text', 'woovoucher' ), 
							'class' 		=> 'woo_vou_hide_pay_your_min_price', 
							'wrap_class' 	=> 'woo_vou_pay_your_price_details',						
						) 
					);
					$this->woo_vou_add_number( 
						array( 
							'id' 			=> $prefix . 'woo_vou_pay_your_max_price', 
							'class' 		=> 'woo_vou_pay_your_price', 
							'wrap_class'	=> 'woo_vou_pay_your_price_details', 
							'label' 		=> sprintf( __('Maximum Price  (%1$s):', 'woovoucher'), get_woocommerce_currency_symbol() ), 
							'field_type' 	=> 'voupayyourprice', 
							'description' 	=> esc_html__( 'The maximum price prevents products from being sold for more than you are willing to accept.', 'woovoucher' ), 
						)
					);
					$this->woo_vou_add_checkbox( 
						array( 
							'id' 			=> $prefix . 'woo_vou_hide_pay_your_max_price', 
							'field_type' 	=> 'voupayyourprice', 
							'label' 		=> esc_html__('Hide Maximum Price Text', 'woovoucher' ), 
							'class' 		=> 'woo_vou_hide_pay_your_max_price', 
							'wrap_class' 	=> 'woo_vou_pay_your_price_details', 
						) 
					);				
				echo '</div>';
				
				do_action( 'woo_vou_add_meta_setting_after_pay_your_price_section', $this );
			}
			...
			if($vendor_flag == true  && $vou_hide_vendor_options == 'yes') { } else { 
				...
				$pdf_template_id = get_post_meta( $post_id, $prefix . 'pdf_template', true);
				$template_style = !empty( $pdf_template_id ) ?  'block_display' : 'no_display';
							
				$this->woo_vou_add_checkbox( array( 'id' => $prefix . 'force_product_template_use', 'class' => $template_style, 'field_type' => 'voutemplates', 'label' => esc_html__('Use Template for past orders :', 'woovoucher' ), 'description' => esc_html__( 'By default PDF Template setting will be used for new orders, check this box to use same template for all past orders associated with this product.', 'woovoucher' ) ) );
			}
	...
	function woo_vou_add_checkbox( $args, $echo = true ) {
		...
		$new_field = array( 'type' => 'checkbox', 'name' => 'Checkbox Field', 'field_type' => 'general', 'default' => false, 'option_name' => '', 'key_name' => '', 'class' => '' );
		$field = array_merge( $new_field, $args );
		...
		$html .= '<p class="form-field ' . $field['id'] . ' ' . $field['class'] . '_field" data-field-type="' . $field['field_type'] . '"><label class="woo-vou-block-section woo-vou-meta-checkbox-label" for="' . $field['id'] . '">' . $field['label'] . '</label>';

		$html .= "<input type='checkbox' class='woo-vou-meta-checkbox {$field['class']}' name='{$field['id']}' id='{$field['id']}'" . checked((!empty($meta) && $meta == 'yes'), true, false) . " />";
	...
	function woo_vou_add_cust_checkbox( $args, $echo = true ) {
		...
		$html .= '<p class="form-field ' . $field['id'] . '_field woo-vou-inline-block-section" data-field-type="' . $field['field_type'] . '"><label class="woo-vou-cust-checkbox-label" for="' . $field['id'] . '"><span>' . $field['label'] . '</span></label>';
	 ...
	 * @package WooCommerce - PDF Vouchers
	 */
	public function woo_vou_add_radio( $args, $echo = true ) {
		...
		$html .= '<div class="form-field ' . $field['id'] . '_field" data-field-type="' . $field['field_type'] . '"><label class="woo-vou-block-section" for="' . $field['id'] . '">' . $field['label'] . '</label>';
	...
	public function woo_vou_add_text( $args, $echo = true ) {  
		...
		$new_field = array( 'type' => 'text', 'class' => '', 'name' => 'Text Field', 'field_type' => 'general', 'placeholder' => '' );
		$field = array_merge( $new_field, $args );

		$meta = woo_vou_meta_value( $field );

		$html .= '<p class="form-field '. $field['id'] . '_field '. $field['wrap_class'] . ' woo-vou-inline-block-section" data-field-type="' . $field['field_type'] . '">';
		$html .= '<label class="woo-vou-custom-meta-label" for="' . $field['id'] . '">' . $field['label'] . '</label>';
		    ...
		    <?php
		    	...
		    	if( $field['id'] == $prefix.'enable_recipient_name' ) {
		    		...
		    		foreach( $delivery_methods as $delivery_method_key => $delivery_method_val ) {
						...
						echo '<div class="recipient-detail-wrap">';
							do_action( 'woo_vou_before_recipient_offline_delivery', $delivery_method_val );
							echo '<div class="recipient-offline-delivery-wrap">';
