...
jQuery( document ).ready( function( $ ) {	
	...
	//if pay your price enabled voucher custom price field will hide START
	if($('#_woo_vou_enabel_pay_your_price').is(":checked")){
		if( WooVouMeta.price_options == '2'){
			$("._woo_vou_voucher_price_field").hide();	
		}
	} else {
		if( WooVouMeta.price_options == '2'){
	...
	$(document).on('change', '#_woo_vou_enabel_pay_your_price', function() { 
		var pay_your_price = $(this).is(":checked");
		if( WooVouMeta.price_options == '2'){
			if( pay_your_price ){
				$("._woo_vou_voucher_price_field").hide();	
			}else{
	...
	//if pay your price enabled voucher custom price field will hide END
	...
	$(document).on('change', '#product-type', function() { 
        ...
        if( product_type != 'simple'  ){
			$("._woo_vou_voucher_price_field").hide();
			$(".woo-vou-tab-voupayyourprice").hide();
			$('#_woo_vou_enabel_pay_your_price').prop('checked', false);

			//pay your price
			$("._woo_vou_enabel_pay_your_price").hide();
			$(".enabel_pay_your_price_detail_wrap").hide();
			$(".woo-vou-tab-voupayyourprice").hide();
		...
		if( product_type == 'simple'  ){
			//pay your price
			$("._woo_vou_enabel_pay_your_price").show();
			$(".enabel_pay_your_price_detail_wrap").show();
			$(".woo-vou-tab-voupayyourprice").show();
		}
	...
	$( document ).on( "click", "#woo_vou_purchased_load_more_btn", function() {
		...
		var data = {
					...
					security				: WooVouMeta.woo_vou_nonce,					
				};
	...
	check_is_enable_pay_your_price_selection();
	...
	if(!WooVouMeta.is_translated) {
		...
		$(document).on('change', '#_woo_vou_woo_vou_pay_your_price_input_field_type', function(){
			if( $(this).val() == 'text' ){
				$('._woo_vou_woo_vou_pay_your_price_input_field_type_amount_values_field').hide();
			}else{
				$('._woo_vou_woo_vou_pay_your_price_input_field_type_amount_values_field').show();
			}
		});

		$('#_woo_vou_woo_vou_pay_your_price_input_field_type_amount_values').on('input', function (event) { 
		...
		if( jQuery('ul.woo-vou-add-tabination li.woo-vou-tab-recipient').hasClass('woo-vou-tab-active') ){
			jQuery('div.woo-vou-delivery-method div.woo-vou-data p input[id^="_woo_vou_recipient_delivery"]').each(function(){
				...
				if( $(this).is(":checked") ) {
					...
					$('.woo_vou_recipient_signed_delivery_details, .woo_vou_recipient_standard_delivery_details').show();
				}
			});
		}
	}
	...
	function check_is_enable_pdf_template_selection(){
		...
		if(jQuery('ul.woo-vou-add-tabination li.woo-vou-tab-voutemplates').hasClass('woo-vou-tab-active')) {
			if( jQuery( '#_woo_vou_enable_pdf_template_selection' ).is( ':checked' ) ){
				...
				jQuery('._woo_vou_force_product_template_use_field').hide();
				...
				jQuery('._woo_vou_force_product_template_use_field').show();
			}
		} else {
	...
	function check_is_enable_pay_your_price_selection(){
	
		if(jQuery('ul.woo-vou-add-tabination li.woo-vou-tab-voupayyourprice').hasClass('woo-vou-tab-active')) {
			if( jQuery( '#_woo_vou_enabel_pay_your_price' ).is( ':checked' ) ){
					
				jQuery('._woo_vou_woo_vou_pay_your_min_price_field').show();
				jQuery('._woo_vou_woo_vou_pay_your_max_price_field').show();
				jQuery('._woo_vou_woo_vou_pay_your_recommended_price_field').show();
				jQuery('.woo_vou_hide_pay_your_min_price_field').show();
				jQuery('.woo_vou_hide_pay_your_max_price_field').show();
				jQuery('._woo_vou_woo_vou_pay_your_price_input_field_type_field').show();
				jQuery('._woo_vou_woo_vou_pay_your_price_input_field_type_amount_values_field').hide();
				
				if( jQuery('#_woo_vou_woo_vou_pay_your_price_input_field_type').find(":selected").val() != 'text'  ){
					jQuery('._woo_vou_woo_vou_pay_your_price_input_field_type_amount_values_field').show();
				}
				
				
			} else {
				
				jQuery('._woo_vou_woo_vou_pay_your_min_price_field').hide();
				jQuery('._woo_vou_woo_vou_pay_your_max_price_field').hide();
				jQuery('._woo_vou_woo_vou_pay_your_recommended_price_field').hide();
				jQuery('.woo_vou_hide_pay_your_min_price_field').hide();
				jQuery('.woo_vou_hide_pay_your_max_price_field').hide();
				jQuery('._woo_vou_woo_vou_pay_your_price_input_field_type_field').hide();
				jQuery('._woo_vou_woo_vou_pay_your_price_input_field_type_amount_values_field').hide();
			}
		} else {
