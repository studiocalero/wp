			...
			if ($_product) {
			   ...
			   $exp_date = '';
				...
				if( $exp_type == 'based_on_gift_date'){
					$recipient_giftdate_value = !empty( $recipient_giftdate['value'] ) ? $recipient_giftdate['value'] : '';
					$start_date = $woo_vou_model->woo_vou_get_date_format($recipient_giftdate_value,true);
					if( empty( $recipient_giftdate_value ) ) {
