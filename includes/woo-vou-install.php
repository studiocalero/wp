...
function woo_vou_install() {
	...
	//Fetch license activation status
	...
	if( $license ){
		...
		include_once( WOO_VOU_ADMIN . '/class-woo-vou-licence-activation.php' );
	...
	if( $woo_vou_set_option == '3.5.6' ) {
		...
		update_option( 'vou_pay_your_price_label', esc_html__( 'Pay Your Price {currency}', 'woovoucher' ) );
		update_option( 'vou_pay_your_price_min_price_label', esc_html__( 'Minimum Price {price}', 'woovoucher' ) );
		update_option( 'vou_pay_your_price_max_price_label', esc_html__( 'Maximum Price {price}', 'woovoucher' ) );
		update_option( 'vou_pay_your_price_recommended_price_label', esc_html__( 'Recommended Price {price}', 'woovoucher' ) );
		update_option( 'vou_pay_your_price_min_price_error_message', esc_html__( 'Price should not be less than minimum price {price}', 'woovoucher' ) );
		update_option( 'vou_pay_your_price_max_price_error_message', esc_html__( 'Price should not be more than maximum price {price}', 'woovoucher' ) );
		update_option( 'vou_pay_your_price_input_error_message', esc_html__( 'Please enter pay your price', 'woovoucher' ) );

		update_option( 'woo_vou_set_option', '3.5.7' );		
	}

	$woo_vou_set_option = get_option( 'woo_vou_set_option' );
	if( $woo_vou_set_option == '3.5.7' ) {
...
function woo_vou_default_settings() {
	...
	$options = array(
					...
					'vou_pay_your_price_label'						=> esc_html__( 'Pay Your Price {currency}', 'woovoucher' ),
					'vou_pay_your_price_min_price_label'			=> esc_html__( 'Minimum Price {price}', 'woovoucher' ),
					'vou_pay_your_price_max_price_label'			=> esc_html__( 'Maximum Price {price}', 'woovoucher' ),
					'vou_pay_your_price_recommended_price_label'	=> esc_html__( 'Recommended Price {price}', 'woovoucher' ),
					'vou_pay_your_price_min_price_error_message'	=> esc_html__( 'Price should not be less than minimum price {price}', 'woovoucher' ),
					'vou_pay_your_price_max_price_error_message'	=> esc_html__( 'Price should not be more than maximum price {price}', 'woovoucher' ),
					'vou_pay_your_price_input_error_message'		=> esc_html__( 'Please enter pay your price', 'woovoucher' ),
				);
