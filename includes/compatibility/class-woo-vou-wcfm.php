...
/**
 * WCFM Marketplace Class. To enhance compatibility with WCFM Store Manager frontend plugin.
 * 
...
class WOO_Vou_Wcfm {
	...
	/**
     * //WCFM Store Manager frontend enqueue_style
     *
     * @package WooCommerce - PDF Vouchers
     * @param  string $end_point end point of current page
	 * @since 4.3.13
	 */

	public function woo_vou_after_wcfm_load_styles( $end_point ) {
		if ( $end_point == 'wcfm-orders-details' ) {
			wp_register_style( 'woo-vou-wcfm-public-styles', WOO_VOU_URL . 'includes/css/woo-vou-wcfm-front-style.css', array(), WOO_VOU_PLUGIN_VERSION );
			wp_enqueue_style( 'woo-vou-wcfm-public-styles' );
		}
	...
	/**
     * Display Voucher Data within order meta, WCFM Store Manager frontend 
     *
     * @package WooCommerce - PDF Vouchers
    ...
    public function woo_vou_end_wcfm_orders_details( $order_id ) {
		...
		$prefix 		= WOO_VOU_META_PREFIX;
		 ...
		 //Get details
       // $order_details  = get_post_meta( $order_id, $prefix .'meta_order_details', true );
       // $order_hide_vou = get_post_meta( $order_id, $prefix .'order_hide_voucher_data', true );
		...
		$woo_vou_order_lang = $woo_order->get_meta( 'wpml_language', true );
		...
		<div class="page_collapsible orders_details_items woo-vou-orders-details-items" ><?php echo esc_html__( 'Voucher Details', 'woovoucher' ); ?><span></span></div>
			<div class="wcfm-container woo-vou-order-history-container">
	...
	public function add_hooks(){
		...
		//WCFM Store Manager frontend display Voucher Data within order meta
		add_action( 'end_wcfm_orders_details', array( $this, 'woo_vou_end_wcfm_orders_details' ) );

		//WCFM Store Manager frontend enqueue style
		add_action( 'after_wcfm_load_styles', array( $this, 'woo_vou_after_wcfm_load_styles' ),100 );
	}	
}